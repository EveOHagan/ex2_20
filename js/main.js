...
function start2AFC() {
    ...
    testImages2 = ["images/images/practice/practice1.jpg","images/images/practice/practice2.jpg","images/images/practice/practice3.jpg", "images/images/practice/practice4.jpg"];
    ...
    "images/images/icon26.jpg", "images/images/icon27.jpg", "images/images/icon28.jpg"]
    ...
    window.sessionStorage.setItem("practiceImages2", JSON.stringify(testImages2))
...
count = 1;
document.getElementById("counter").innerHTML = "You are on image " + count + " of 32"
random2AFC();
...
var firebaseConfig = {
    apiKey: "AIzaSyCVfydw6aVhGnknVPyQKd7FXGuCSuFpI2A",
    authDomain: "groupe-94273.firebaseapp.com",
    projectId: "groupe-94273",
    storageBucket: "groupe-94273.appspot.com",
    messagingSenderId: "1091005927323",
    appId: "1:1091005927323:web:3a09dde0ddac1696d4db3e",
    measurementId: "G-2QJPX8KCS4"
  };
// Initialize Firebase
...
function random2AFC() {
    ...
    var practiceImages2 = JSON.parse(window.sessionStorage.getItem("practiceImages2"));
    ...
    practiceImagesSort2 = practiceImages2.sort(() => Math.random() - 0.5);
    document.getElementById("counter").innerHTML = "Trial " + count + " of 32";
    
    imagesSorted = images.sort(() => Math.random() - 0.5);
    images2Sorted = images_2.sort(() => Math.random() - 0.5);
    ...
    if (practiceImages.length > 0) {
       ...
       if (images.length == 0) {
        ...
        image.src = images2Sorted[a]
        image2.src = images2Sorted[b]
        count = count + 1;
        images2Sorted.splice(0,2)
       }
    } else {
    image.src = imagesSorted[a]
    image2.src = imagesSorted[b]
    count = count + 1;
    imagesSorted.splice(0,2)
    }
...
function startRank(){ 
    ...
    practiceArray[0] = ["images/images/practice/practice1.jpg", "images/images/practice/practice2.jpg", "images/images/practice/practice3.jpg", "images/images/practice/practice4.jpg"]
    ...
    count = 1;
    document.getElementById("counter").innerHTML = "Trial " + count + " of 15 "
...
function startYN(){
    ...
    // 4 practice images
    var practiceArray = ["images/images/practice/practice1.jpg", "images/images/practice/practice2.jpg", "images/images/practice/practice3.jpg", "images/images/practice/practice4.jpg"]
    ...
    var yesorno = {};
    window.sessionStorage.setItem("yesorno", JSON.stringify(yesorno));
    window.sessionStorage.setItem("images", JSON.stringify(imageArray));
    window.sessionStorage.setItem("practice", JSON.stringify(practiceArray));
...
function storeYN(id){
        ...
        var dictionary = JSON.parse(window.sessionStorage.getItem("yesorno"));
        var img = document.getElementById("mainImage");
        var img_file = img.src.slice(-9);
        var radio = document.getElementsByName("yesNo");
        var yesno = id;
        var picked = [img_file, yesno]
        console.log(picked)
         ...
         for (var i = 0; i < radio.length; i++)
        {
            if (radio[i].checked)
            {
                yesorno = (radio[i].value)
                dictionary[img_file] = yesorno;
                radio[i].checked = false;
                console.log(dictionary)
                window.sessionStorage.setItem("yesorno", JSON.stringify(dictionary));
            }
        } 
        changeYN();
...
function changeYN(){
        ...
        practiceRandom = practice.sort(() => Math.random() - 0.5);
    
        if (practiceRandom.length > 0 ){
            img.src = practiceRandom[0]
            practiceRandom.splice(0, 1)
            window.sessionStorage.setItem("practice", JSON.stringify(practice))
        } else {
            if (counter % 15 == 0 ) {
                img.src = ("images/images/break_yn.png")
        } else {
            if (images.length == 0) {
                sendYN();
            }
...
function sendYN(){
    ...
    var yesorno = JSON.parse(window.sessionStorage.getItem("yesorno"));
    yesorno["timestamp"] = firebase.firestore.FieldValue.serverTimestamp();
  ...
  firebase.initializeApp(firebaseConfig);
  const db = firebase.firestore();
  db.collection("yesorno").doc().set(yesorno)
